...
K = 1;
coeff = zeros(10, 1);
coeff(1, 1) = 0.0331786 * K;
coeff(2, 1) = 0.0475946 * K;
coeff(3, 1) = 0.0433493 * K;
coeff(4, 1) = 0.0223439 * K;
coeff(5, 1) = 0.0029723 * K;
coeff(6, 1) = 0.0035297 * K;
coeff(7, 1) = 0.0108719 * K;
coeff(8, 1) = 0.00598837 * K;
coeff(9, 1) = 0.00697794 * K;
coeff(10, 1) = 0.00108023 * K;
