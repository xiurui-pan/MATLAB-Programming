...
c = struct("Ab0", ones(1:10), "Ao0", ones(1:10), "Bb0", ones(1:10), "Bo0", ones(1:10), "Co1", ones(1:10), "Db1", ones(1:10), "Do1", ones(1:10), "Eb1", ones(1:10), "Eo1", ones(1:10), "Fo1", ones(1:10), "Gb1", ones(1:10), "Go1", ones(1:10), "Ab1", ones(1:10), "Ao1", ones(1:10), "Bo1", ones(1:10), "Co2", ones(1:10), "Db2", ones(1:10), "Do2", ones(1:10));
...
c.("Do1") = c.("Db1");
c.("Eb1") = [0.03362, 0.029, 0.014, 0.0224, 0.00296, 0.00188, 0.022, 0.005926, 0.00701, 0.001037];
c.("Eo1") = c.("Eb1");
